...
def user_choice(List_images, n): #à modifier pour être ok avec l'interface graphique
    ...
    List_num = []
    List_images_chosen = []
    str_images_chosen = input(f"Choose {n} images among those displayed that are the closest to the suspect and write the position of each image chosen separated by a coma (ex : 1,5 = 1st image, 5th one) :  ")
