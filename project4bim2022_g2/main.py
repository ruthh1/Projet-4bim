...
def contenu_window(z):
    TextFrame=tk.LabelFrame(window2,width=window_width,height=0.19*window_height, bg="white")
    ...
    ImageFrame1=tk.LabelFrame(window2,width=0.2*window_width,height=0.38*window_height, bg="white")
    #ImageFrame1.configure(bg="grey")
    ImageFrame1.place(x=0,rely=0.19)

    ImageFrame2=tk.LabelFrame(window2,width=0.2*window_width,height=0.38*window_height, bg="white")
    #ImageFrame2.configure(bg="grey")
    ImageFrame2.place(relx=0.2,rely=0.19)

    ImageFrame3=tk.LabelFrame(window2,width=0.2*window_width,height=0.38*window_height, bg="white")
    #ImageFrame3.configure(bg="grey")
    ImageFrame3.place(relx=0.4,rely=0.19)

    ImageFrame4=tk.LabelFrame(window2,width=0.2*window_width,height=0.38*window_height, bg="white")
    #ImageFrame4.configure(bg="grey")
    ImageFrame4.place(relx=0.6,rely=0.19)

    ImageFrame5=tk.LabelFrame(window2,width=0.2*window_width,height=0.38*window_height, bg="white")
    #ImageFrame5.configure(bg="grey")
    ImageFrame5.place(relx=0.8,rely=0.19)

    ImageFrame6=tk.LabelFrame(window2,width=0.2*window_width,height=0.38*window_height, bg="white")
    #ImageFrame6.configure(bg="grey")
    ImageFrame6.place(relx=0 ,rely=0.57)

    ImageFrame7=tk.LabelFrame(window2,width=0.2*window_width,height=0.38*window_height, bg="white")
    #ImageFrame7.configure(bg="grey")
    ImageFrame7.place(relx=0.2,rely=0.57)

    ImageFrame8=tk.LabelFrame(window2,width=0.2*window_width,height=0.38*window_height, bg="white")
    #ImageFrame8.configure(bg="grey")
    ImageFrame8.place(relx=0.4,rely=0.57)

    ImageFrame9=tk.LabelFrame(window2,width=0.2*window_width,height=0.38*window_height, bg="white")
    #ImageFrame9.configure(bg="grey")
    ImageFrame9.place(relx=0.6,rely=0.57)

    ImageFrame10=tk.LabelFrame(window2,width=0.2*window_width,height=0.38*window_height, bg="white")
    #ImageFrame10.configure(bg="grey")
    ImageFrame10.place(relx=0.8,rely=0.57)

    Frame_bas=tk.LabelFrame(window2,width=window_width,height=0.05*window_height, bg="white")
    #ImageFrame10.configure(bg="grey"),
    ...
    Button6=tk.Button(ImageFrame6,command=lambda:[returnperson(5),ChangeColor(Button6)] ,text="Person 6",width=15)
    Button6.place(relx=0.2,rely=0.85)

    Button7=tk.Button(ImageFrame7,command=lambda:[returnperson(6),ChangeColor(Button7)] ,text="Person 7",width=15)
    Button7.place(relx=0.2,rely=0.85)

    Button8=tk.Button(ImageFrame8,command=lambda:[returnperson(7),ChangeColor(Button8)] ,text="Person 8",width=15)
    Button8.place(relx=0.2,rely=0.85)

    Button9=tk.Button(ImageFrame9,command=lambda:[returnperson(8),ChangeColor(Button9)] ,text="Person 9",width=15)
    Button9.place(relx=0.2,rely=0.85)

    Button10=tk.Button(ImageFrame10,command=lambda:[returnperson(9),ChangeColor(Button10)] ,text="Person 10",width=15)
    Button10.place(relx=0.2,rely=0.85)

    print("Iteration", iteration)


    L_frame = [ImageFrame1, ImageFrame2, ImageFrame3, ImageFrame4, ImageFrame5, ImageFrame6,ImageFrame7, ImageFrame8, ImageFrame9, ImageFrame10]
    ...
    if iteration == (nbre_iter_max-1):
        messagebox.showwarning("Last iteration", "This is the last iteration, you have to choose only one image that will be the one of the suspect")
        button_next.destroy()
    window2.mainloop()
